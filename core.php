...
class helper {
	...
	/* Désactivation temporaire de la recherche de MAJ officielle
...
class layout extends common {
	...
	public function showCopyright() {
		...
		$items .= 'Motorisé par <a href="http://forum.zwiicms.com/index.php?/files/file/73-zwii4free/" target="_blank">Zwii4Free</a>';
		...
		foreach($this->getHierarchy() as $parentPageId => $childrenPageIds) {
			...
			$items .= $this->getData(['page', $parentPageId, 'title']);
				...
				case 'icon' :
				    ...
				    $items .= '<img alt="" src="'. helper::baseUrl(false) .'site/file/source/'.$this->getData(['page', $parentPageId, 'iconUrl']).'" />';
				    } else {
				    $items .= $this->getData(['page', $parentPageId, 'title']);
				    }
				    break;
				case 'icontitle' :
				    if ($this->getData(['page', $parentPageId, 'iconUrl']) != "") {
				    $items .= '<img alt="" src="'. helper::baseUrl(false) .'site/file/source/'.$this->getData(['page', $parentPageId, 'iconUrl']).'" title="';
				    $items .= $this->getData(['page', $parentPageId, 'title']).'"/>';
				    } else {
				    $items .= $this->getData(['page', $parentPageId, 'title']);
				    }
